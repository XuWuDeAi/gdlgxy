...
import main.zm.gdlgxy.activity.ImportActivity;
...
public class MoreWindow extends PopupWindow implements OnClickListener {
    ...
    public void init(View view) {
        ...
        mHeight = metrics.heightPixels + mContext.getResources().getDimensionPixelSize(mContext.getResources().getIdentifier("status_bar_height", "dimen", "android"));
    ...
    public void showMoreWindow(View anchor) {
        ...
        showAtLocation(anchor, Gravity.TOP | Gravity.START, 0, -mContext.getResources().getDimensionPixelSize(mContext.getResources().getIdentifier("status_bar_height", "dimen", "android")));
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.tv_sbs:
                ...
                intent.putExtra("weburl", "http://jwc.gdlgxy.com/");
                mContext.startActivity(intent);
                break;
            case R.id.tv_search:
                Intent intent2 = new Intent(mContext, ImportActivity.class);
                mContext.startActivity(intent2);
                break;
            case R.id.tv_course:
                ClipboardUtils.copyText(ScheduleService.getSpWeek((MainActivity) mContext));
                ((MainActivity) mContext).toast("已复制数据源");
                break;
            case R.id.tv_task:
                Intent intent1 = new Intent(mContext, AddScheduleActivity.class);
